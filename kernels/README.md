...
|---|---|---|
| [aie2/conv_engine](aie2/conv_engine/design.py) | The whole YOLOv8n graph (63 convs, 3 SPPF pools): one persistent packet-driven program on 16 cores, weights streamed per packet, activations in a DDR workspace | **Every layer bit-exact on Device 0** (and offline against ONNX Runtime); 66-layer dispatch 7.2 ms with the coarse schedule and 7.9 ms witnessed glass-to-glass. [Evidence and limits](../docs/BENCHMARKS.md#whole-network-yolov8n-on-a-16-core-convolution-engine-every-layer-on-the-npu-bit-exact-2026-09-13-desktop-2). Two opt-in MemTile structures, an activation ring and a resident weight buffer, are byte-exact and slower, and stay off ([evidence](../docs/BENCHMARKS.md#memtile-residency-does-not-pay-on-the-graph-engine-and-the-yolov8s-gap-is-a-known-limitation-2026-09-16-desktop-2)) |
