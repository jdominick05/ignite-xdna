            ...
            for s_idx, s_path, ws_bytes in [(1, stage1_path, 4096), (2, stage2_path, 8192)]:
                ...
                manifest = {
                    ...
                    "graph_engine": {
                        ...
                        "heads": {},
                        "placements": {"x": {"base": 0, "halo": 0, "height": 10, "width": 10, "blocks": 1,
                                             "planes": 1, "channels": 8, "dtype": "uint8"}},
                        "decoupled_weights": True,
        ...
        with tempfile.TemporaryDirectory(ignore_cleanup_errors=True) as tmpdir:
            ...
            manifest = {
                ...
                "graph_engine": {
                    ...
                    "heads": {},
                    "placements": {
                        "input": {"base": 0, "halo": 0, "height": 10, "width": 10, "blocks": 1, "planes": 1,
                                  "channels": 8, "dtype": "uint8"},
                        "p5_out": {"base": 8192, "halo": 0, "height": 20, "width": 20, "blocks": 4, "planes": 4,
                                   "channels": 32, "dtype": "uint8"},
                    },
                    "decoupled_weights": True,
                    "weights_file": w_path.name,
                    "weights_sha256": hashlib.sha256(mock_weights).hexdigest(),
