...
def generate_fused_mlir(out_path: str = None) -> str:
    """Generates kernels/aie2/im2col_fused_2layer.mlir with L2 MemTile ping-pong buffers."""
    if out_path is None:
        out_path = str(get_repo_root() / "kernels" / "aie2" / "im2col_fused_2layer.mlir")
