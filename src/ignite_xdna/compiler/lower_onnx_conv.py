...
def execute_fused_2layer_on_silicon(
    ...
    """
    from ignite_xdna.runtime.test_im2col_hardware import (
        XrtSiliconHarness,
...
def lower_and_execute_conv(args: argparse.Namespace):
    if getattr(args, 'fused_2layer', False):
        ...
        fused_init_path = str(_repo_root / "build" / "layer_fused_init.bin")
        fused_exec_path = str(_repo_root / "build" / "layer_fused_exec.bin")
