...
| `pipelines/yolov11` | YOLOv11n detection (C3k2 + C2PSA attention) | **Fractured (6/1300 nodes, 33.29 ms)** on AMD's stack due to C2PSA 4D MatMul; ablated backbone runs at **7.08 ms (1173/1180 nodes)**. The graph engine runs it with only the attention core on the CPU, at 34.63 mAP@50-95 against AMD's 25.82 and 2.17x its speed ([carve](docs/BENCHMARKS.md#yolo11ns-carve-the-narrow-one-is-free-on-accuracy-074-ms-faster-and-unlocks-883-map-2026-09-21-desktop-2)) |
