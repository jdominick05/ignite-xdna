...
| [yolov8_split_suite_phoenix_20260920.log](yolov8_split_suite_phoenix_20260920.log) | Full-family physical silicon benchmark across all six YOLOv8 variants (yolov8n, yolov8s, yolov8n-pose, yolov8m, yolov8l, yolov8x) pinned to 8 physical CPU cores (0x5555, OMP_NUM_THREADS=8): decoupled stationary weights collapse container artifacts by 90.5%–96.8% (down to 0.68–8.67 MB); inter-segment chained dispatch overhead measured at 17.7–49.9 µs; Segment 0 early-exit cascades achieve 2.01 ms (n, 498.7 FPS), 4.64 ms (s, 215.4 FPS), 2.29 ms (pose, 437.4 FPS), 11.24 ms (m, 89.0 FPS), 19.53 ms (l, 51.2 FPS), and 32.95 ms (x, 30.3 FPS), cutting latency uniformly by 72.1%–75.0% and outperforming AMD's monolithic passes by 2.40× to 5.23×. |
