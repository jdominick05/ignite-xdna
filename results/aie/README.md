...
## Dispatch, readback and SIMD host optimization

| Log | Outcome |
|---|---|
| [latency_balanced_dispatch_opt_phoenix_20260917T1250Z.log](latency_balanced_dispatch_opt_phoenix_20260917T1250Z.log) | Interleaved same-sitting AMD comparison in `balanced` default after dispatch, readback, and SIMD host optimizations (direct C8 channel-blocked native decode, consolidated head sync spans, native SIMD depth-to-space and resize ingress for SESR M7): 50 warm-up and 500 timed frames per run, NPU idle before every group. SESR M7 cut from 6.83 ms to 4.783 / 4.766 ms (AMD 4.543 / 4.576 ms; gap slashed from 2.48 ms down to ~0.20 ms); YOLOv8s readback cut in half to 0.312 / 0.310 ms and G2G to 17.950 / 17.940 ms (AMD 16.966 / 16.916 ms); YOLOv8n 8.309 / 8.349 ms (AMD 10.637 / 10.530 ms); YOLOv8n-pose 8.981 / 8.952 ms (AMD 12.137 / 12.220 ms) — [BENCHMARKS](../../docs/BENCHMARKS.md#dispatch-readback-and-simd-host-optimization-in-the-balanced-default-2026-09-17-desktop-2) |
