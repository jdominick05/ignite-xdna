...
| [sesr_m7_adaround_bf16_dump_desktop2_20260923.log](sesr_m7_adaround_bf16_dump_desktop2_20260923.log) | Silicon, checks-only, device idle either side: the same seven frames again with --dump-frames and --isolate all. Every count of the sitting above reproduces. Every layer still resident at frame end (head, body.5, body.6 with its Add, tail), replayed from the device's own inputs, is exact under the aligned model: 23,592,960 values, 0 differ. The dump itself is git-ignored; its file hashes are in the log. - [BENCHMARKS](../../docs/BENCHMARKS.md#w8a16-sesr-m7-on-the-adaround-weights-the-device-departs-from-the-emulator-on-4-of-6-inputs-and-the-accuracy-passes-amds-adaround-2026-09-23-desktop-2) |
