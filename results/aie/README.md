...
| [engine_bf16_loop_variants_exact_npu_20260921.log](engine_bf16_loop_variants_exact_npu_20260921.log) | The chunk variant (the largest rewrite) on the device: byte-exact on all ten sweep cases including the two-packet F_LOAD_PSUM chains, and its multiply-accumulate probe answers identical to the committed kernel's (aligned 1,600/1,600 on both sets). checks-only, no timing claim. - [BENCHMARKS](../../docs/BENCHMARKS.md#five-arithmetic-neutral-rewrites-of-the-bf16-hot-loop-cut-its-bundles-by-up-to-a-third-and-the-wall-clock-did-not-move-2026-09-21-desktop-2) |
| [engine_bf16_loop_variants_bench_k3_npu_20260921.log](engine_bf16_loop_variants_bench_k3_npu_20260921.log) | Timing, k3 over 4 input blocks, five alternating rounds, 128 in-core repeats, timing_eligible true: base 10.093 us per pass dispatch-free; ptr 10.168; chunk 10.228; hoist 10.094; hoist+ptr 10.134; milestone-1 fixed-shape 9.173. Static loop savings of 21-33 percent produced -0.0 to +1.3 percent: the loop's bundle count is not its cycle count on this engine, as H11 found on the GEMM. - [BENCHMARKS](../../docs/BENCHMARKS.md#five-arithmetic-neutral-rewrites-of-the-bf16-hot-loop-cut-its-bundles-by-up-to-a-third-and-the-wall-clock-did-not-move-2026-09-21-desktop-2) |
| [engine_bf16_loop_variants_bench_k1_npu_20260921.log](engine_bf16_loop_variants_bench_k1_npu_20260921.log) | The same arms at k1 over 8 input blocks: base 3.198 us, ptr 3.204, chunk 3.209, hoist 3.239, hoist+ptr 3.239, milestone-1 2.084. The base loop bodies are 1.47 us of the 3.20 (DERIVED), so more than half of a 1x1 pass is per-pass cost outside the loop, and hoisting the bias is not where it goes. Unattributed. - [BENCHMARKS](../../docs/BENCHMARKS.md#five-arithmetic-neutral-rewrites-of-the-bf16-hot-loop-cut-its-bundles-by-up-to-a-third-and-the-wall-clock-did-not-move-2026-09-21-desktop-2) |
